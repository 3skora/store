    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                res.json({
                    status: 'success',
                    message: "Product ".concat(newProduct.name, " created successfully"),
...
var getAllProducts = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var category, allProducts, _a, error_2;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                return [3 /*break*/, 4];
            case 2: return [4 /*yield*/, productModel.getProductByCategory(category)];
            case 3:
                _a = (allProducts = _b.sent());
                _b.label = 4;
            case 4:
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                id = req.params.id;
                return [4 /*yield*/, productModel.getProduct(id)];
            case 1:
                Product = _a.sent();
                if (!Product)
                    throw new Error();
                return [2 /*return*/, res.json({
                        status: 'success',
                        message: "Product ".concat(id, " retrieved successfully"),
                        data: Product
                    })];
            case 2:
                error_3 = _a.sent();
...
var updateProduct = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var id, foundProduct, updatedValues, updatedProduct, error_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
            ...
            case 1:
                ...
                updatedValues = __assign(__assign({}, foundProduct), req.body);
                return [4 /*yield*/, productModel.updateProduct(id, updatedValues)];
            case 2:
                updatedProduct = _a.sent();
                res.json({
                    status: 'success',
                    message: "Product ".concat(id, " updated successfully"),
                    data: updatedProduct
                });
                return [3 /*break*/, 4];
            case 3:
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                id = req.params.id;
                return [4 /*yield*/, productModel.deleteProduct(id)];
            case 1:
                deletedProduct = _a.sent();
                res.json({
                    status: 'success',
                    message: "Product ".concat(id, " deleted successfully"),
                    data: deletedProduct
                });
                return [3 /*break*/, 3];
            case 2:
